...
public inline fun rappelPitch(block: app.rappeloids.protos.v1.RappelPitchKt.Dsl.() -> kotlin.Unit): app.rappeloids.protos.v1.RappelPitch =
  app.rappeloids.protos.v1.RappelPitchKt.Dsl._create(app.rappeloids.protos.v1.RappelPitch.newBuilder()).apply { block() }._build()
/**
...
public object RappelPitchKt {
  ...
  public class Dsl private constructor(
    private val _builder: app.rappeloids.protos.v1.RappelPitch.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: app.rappeloids.protos.v1.RappelPitch.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): app.rappeloids.protos.v1.RappelPitch = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun app.rappeloids.protos.v1.RappelPitch.copy(block: `app.rappeloids.protos.v1`.RappelPitchKt.Dsl.() -> kotlin.Unit): app.rappeloids.protos.v1.RappelPitch =
  `app.rappeloids.protos.v1`.RappelPitchKt.Dsl._create(this.toBuilder()).apply { block() }._build()
