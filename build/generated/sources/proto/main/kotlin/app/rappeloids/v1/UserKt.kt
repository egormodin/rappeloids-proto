...
public inline fun user(block: app.rappeloids.v1.UserKt.Dsl.() -> kotlin.Unit): app.rappeloids.v1.User =
  app.rappeloids.v1.UserKt.Dsl._create(app.rappeloids.v1.User.newBuilder()).apply { block() }._build()
/**
 * ```
...
public object UserKt {
  ...
  public class Dsl private constructor(
    private val _builder: app.rappeloids.v1.User.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: app.rappeloids.v1.User.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): app.rappeloids.v1.User = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun app.rappeloids.v1.User.copy(block: `app.rappeloids.v1`.UserKt.Dsl.() -> kotlin.Unit): app.rappeloids.v1.User =
  `app.rappeloids.v1`.UserKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val app.rappeloids.v1.UserOrBuilder.createTimeOrNull: com.google.protobuf.Timestamp?
  get() = if (hasCreateTime()) getCreateTime() else null

public val app.rappeloids.v1.UserOrBuilder.updateTimeOrNull: com.google.protobuf.Timestamp?
