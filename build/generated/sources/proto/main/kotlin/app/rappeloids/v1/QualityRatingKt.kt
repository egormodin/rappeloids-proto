...
public inline fun qualityRating(block: app.rappeloids.v1.QualityRatingKt.Dsl.() -> kotlin.Unit): app.rappeloids.v1.QualityRating =
  app.rappeloids.v1.QualityRatingKt.Dsl._create(app.rappeloids.v1.QualityRating.newBuilder()).apply { block() }._build()
/**
...
public object QualityRatingKt {
  ...
  public class Dsl private constructor(
    private val _builder: app.rappeloids.v1.QualityRating.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: app.rappeloids.v1.QualityRating.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): app.rappeloids.v1.QualityRating = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun app.rappeloids.v1.QualityRating.copy(block: `app.rappeloids.v1`.QualityRatingKt.Dsl.() -> kotlin.Unit): app.rappeloids.v1.QualityRating =
  `app.rappeloids.v1`.QualityRatingKt.Dsl._create(this.toBuilder()).apply { block() }._build()
