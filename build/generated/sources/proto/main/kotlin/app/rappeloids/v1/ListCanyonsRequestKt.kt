...
public inline fun listCanyonsRequest(block: app.rappeloids.v1.ListCanyonsRequestKt.Dsl.() -> kotlin.Unit): app.rappeloids.v1.ListCanyonsRequest =
  app.rappeloids.v1.ListCanyonsRequestKt.Dsl._create(app.rappeloids.v1.ListCanyonsRequest.newBuilder()).apply { block() }._build()
/**
...
public object ListCanyonsRequestKt {
  ...
  public class Dsl private constructor(
    private val _builder: app.rappeloids.v1.ListCanyonsRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: app.rappeloids.v1.ListCanyonsRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): app.rappeloids.v1.ListCanyonsRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun app.rappeloids.v1.ListCanyonsRequest.copy(block: `app.rappeloids.v1`.ListCanyonsRequestKt.Dsl.() -> kotlin.Unit): app.rappeloids.v1.ListCanyonsRequest =
  `app.rappeloids.v1`.ListCanyonsRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
