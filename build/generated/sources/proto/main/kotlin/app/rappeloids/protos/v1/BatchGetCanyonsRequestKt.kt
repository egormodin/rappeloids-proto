...
public inline fun batchGetCanyonsRequest(block: app.rappeloids.protos.v1.BatchGetCanyonsRequestKt.Dsl.() -> kotlin.Unit): app.rappeloids.protos.v1.BatchGetCanyonsRequest =
  app.rappeloids.protos.v1.BatchGetCanyonsRequestKt.Dsl._create(app.rappeloids.protos.v1.BatchGetCanyonsRequest.newBuilder()).apply { block() }._build()
/**
...
public object BatchGetCanyonsRequestKt {
  ...
  public class Dsl private constructor(
    private val _builder: app.rappeloids.protos.v1.BatchGetCanyonsRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: app.rappeloids.protos.v1.BatchGetCanyonsRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): app.rappeloids.protos.v1.BatchGetCanyonsRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun app.rappeloids.protos.v1.BatchGetCanyonsRequest.copy(block: `app.rappeloids.protos.v1`.BatchGetCanyonsRequestKt.Dsl.() -> kotlin.Unit): app.rappeloids.protos.v1.BatchGetCanyonsRequest =
  `app.rappeloids.protos.v1`.BatchGetCanyonsRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
